...
// Inject styles
$(parentBody).append(`<style type="text/css">
  #bannerContainer {
    position: fixed;
    top: 50%;
    left: 50%;
...
// Inject iframe + click layer + close button
$(parentBody).append(`
  <div id="bannerContainer">
    <div id="bannerWrapper">
      <span id="welcomeBannerClosebutton">
        <img src="https://ms.freeyfi.com/gallery/2025/savoy/floating/cltobtn.png"
             class="welcomeBannerClosebuttonImg" alt="Close">
      </span>

      <iframe id="banner"
              src="https://go-zayan-full.vercel.app/"
...
// Click URL
var clickTag = 'https://gozayaan.com/';

$(document).ready(function () {
  // Click layer redirect
  $('#clickLayer', window.parent.document).on('click', function () {
    window.open(clickTag, '_blank');
  });

  // Manual close (button + image)
  $(
    '#welcomeBannerClosebutton, .welcomeBannerClosebuttonImg',
    window.parent.document
  ).on('click', function () {
    $('#bannerContainer', window.parent.document).fadeOut('slow', function () {
      $(this).remove();
    });
  });
